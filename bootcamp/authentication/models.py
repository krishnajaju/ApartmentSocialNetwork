...
from bootcamp.authentication.choices import *
class Profile(models.Model):
    user = models.OneToOneField(User)
    location = models.CharField(max_length=50, null=True, blank=True)
    url = models.CharField(max_length=50, null=True, blank=True)
    job_title = models.IntegerField(choices=JOB_CHOICES, default=OTHER)
    # reputation = models.IntegerField(default=0)
    # language = models.CharField(max_length=5, default='en')

    #<my code added

    type = models.IntegerField(choices=TYPE_CHOICES, default=RESIDENT)
    #>my code added
    class Meta:
    ...
    def get_job_title(self):
        ...
        return JOB_CHOICES[job_title - 1][1]  #one based indexing in JOB_CHOICES

    def get_type(self):
       type = self.type
       return TYPE_CHOICES[type][1]
